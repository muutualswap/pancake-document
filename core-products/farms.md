...
**Initial Liquidity Pools \(LPs\) for farming BGSP tokens:**
...
**\*\*\[**Get your FLIP tokens \(BigSwap Liquidity Provider Tokens\) HERE**\]\(**[https://exchange.pancakeswap.finance/\#/swap](https://exchange.pancakeswap.finance/#/swap)**\)**.\*\*
